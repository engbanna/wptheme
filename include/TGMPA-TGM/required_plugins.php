...
function my_theme_register_required_plugins() {
	$plugins = array(
		...
		array(
			'name'        => 'Brand In Content',
			'slug'        => 'brand-in-content',
			'required'  => true,
			'force_activation'   => true,
		),
		array(
			'name'        => 'Rename Default Post',
			'slug'        => 'rename-default-post',
			'required'  => false,
			'force_activation'   => false,
		),
        array(
		...
		array(
			...
			'source'             => get_stylesheet_directory() . '/include/plugins/acf-options-page.zip', // The plugin source.
		...
		array(
			...
			'source'             => get_stylesheet_directory() . '/include/plugins/acf-gallery.zip', // The plugin source.
			'required'           => false, // If false, the plugin is only 'recommended' instead of required.
		),
		array(
			'name'               => 'Advanced Custom Fields: Repeater Field', // The plugin name.
			'slug'               => 'acf-repeater', // The plugin slug (typically the folder name).
			'source'             => get_stylesheet_directory() . '/include/plugins/acf-repeater.zip', // The plugin source.
			'required'           => false, // If false, the plugin is only 'recommended' instead of required.
		),
		array(
			'name'               => 'Advanced Custom Fields: Flexible Content', // The plugin name.
			'slug'               => 'acf-flexible-content', // The plugin slug (typically the folder name).
			'source'             => get_stylesheet_directory() . '/include/plugins/acf-flexible-content.zip', // The plugin source.
			'required'           => false, // If false, the plugin is only 'recommended' instead of required.
		),
